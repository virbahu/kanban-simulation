...
*Reducing waste and improving flow through pull-based production systems*

---

## 📋 Overview

**Kanban Simulation** addresses a critical challenge in modern supply chain management: lean manufacturing. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor Taiichi Ohno**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain lean manufacturing is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize lean manufacturing typically see:
...
```bash
git clone https://github.com/virbahu/kanban-simulation.git
cd kanban-simulation
pip install -r requirements.txt
python kanban_simulation.py
```
...
# See docstrings in kanban_simulation.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor Taiichi Ohno, Toyota Production System |
| **Key Reference** | See academic references for Professor Taiichi Ohno |
